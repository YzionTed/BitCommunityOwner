...
public class StoreElevatorListBeans {

    private List<ElevatorListBean> elevatorListBeans;
    private long storeTime;

    public List<ElevatorListBean> getElevatorListBeans() {
        return elevatorListBeans;
    }

    public void setElevatorListBeans(List<ElevatorListBean> elevatorListBeans) {
        this.elevatorListBeans = elevatorListBeans;
    }
