...
public class YunDuiJIangUtils {
    ...
    public void login(String name, String password) {
        IntercomSDKProxy.initIntercomAccount(mIntercomAccountProxy);
        IntercomSDKProxy.login(name, password);
    }
...
//            IntercomSDK.reInitIntercomSDK();
        ...
        public int onNewListInfo() {
            ...
            PreferenceUtils.setPrefString(BaseApplication.getInstance().getContext(), PreferenceConst.PRE_NAME, PreferenceConst.MILIDOORDEVICE, new Gson().toJson(doorMiLiDevicesBean));
